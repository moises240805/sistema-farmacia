                            ...
                            <div class="divider-vertical"></div>
                                <div class="p-5">
                                    ...
                                    <form class="formulario user" onsubmit="return formulario_validaciones()" action="index.php?url=autenticator&action=cambiar&<?php echo 'token=' . htmlspecialchars($_GET['token']); ?>" method="post">
                                        ...
                                        <div class="form-group">
                                            <div class="input-group">
                                                 <span class="input-group-text" id="basic-addon1"
                                                    ><i class="fa fa-lock"></i></span
                                                    >
                                                <input class="form-control form-control-user input_pw" type="text" name="codigo" id="codigo" placeholder="ingrese codigo" required oninput="codigo_validacion()">
                                        ...
                                        <br>
                                        <button class="btn btn-outline-primary btn-block btn-round iniciar_seccion" type="">CAMBIAR PASSWORD</button>
                                    </form>
                                    <br>
                                    <center>
