...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-03-2026 a las 19:44:53
...
INSERT INTO `recuperar_codigos` (`id`, `usuario_id`, `codigo`, `token`, `expira`, `usado`, `created_at`) VALUES
(28, 25, '896347', '58b779e2d7332dfb4d5eaf8946161cf9c63d322f66df13bbad314a34e2bee837', '2026-03-15 18:29:07', 1, '2026-03-15 21:29:07'),
(30, 23, '476590', 'c67ae42b9872260ae1ef23f05a0178cf029225d5d9234665e47733e7996cc9c2', '2026-03-15 18:34:10', 1, '2026-03-15 21:34:10');
...
INSERT INTO `roles` (`rol_id`, `rol_nombre`, `status`) VALUES
(1, 'Superusuario', 1),
(2, 'Administrador', 1),
(3, 'Usuario', 1),
(4, 'Vendedor', 1),
...
INSERT INTO `usuarios` (`usuario_id`, `usuario_nombre`, `usuario_email`, `usuario_password`, `usuario_rol_id`, `status`) VALUES
(23, '@moises_24', 'david24queralez@gmail.com', '$2y$10$W3VhxfFY18GKJVUZcrD0eeKczRYPhRAbcBiVi5UMyRtUCgCYo2odi', 2, 1),
(24, '@william_10', 'william@gmail.com', '$2y$10$QkDi5s1tdedyD.aU5AnUMuYkofW9BO2vkDaHWLaDsp/ssOAwpb0.O', 3, 1),
(25, '@superusurio_24', 'moises2005pereira@gmail.com', '$2y$10$rn4UMQQPgmVzKe9JWvA8w.ATFRgc45L2vQd.J07NjnEOBroZxb.Rm', 1, 1);
...
--
ALTER TABLE `roles`
  MODIFY `rol_id` int(25) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `usuarios`
  MODIFY `usuario_id` int(25) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
...
--
ALTER TABLE `recuperar_codigos`
  ADD CONSTRAINT `recuperar_codigos_ibfk_1` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`usuario_id`) ON DELETE CASCADE ON UPDATE CASCADE;
