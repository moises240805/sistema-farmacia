        ...
        <div class="sidebar-wrapper scrollbar scrollbar-inner">
          <div class="sidebar-content">
            <ul class="nav nav-secondary">
              ...
              <li class="nav-item">
                <a data-bs-toggle="collapse" href="index.php?url=clientes">
              ...
              <li class="nav-item">
                <a data-bs-toggle="collapse" href="index.php?url=proveedores">
              ...
              <li class="nav-item">
                <a data-bs-toggle="collapse" href="index.php?url=ventas">
